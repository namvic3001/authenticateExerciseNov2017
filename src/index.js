...
// root.innerHTML =
//  `this is NEW11 text set by src/index.js, replacing old text in
...
//   a source  to compile the public/bundle.js file`
  ...
  //now add react library, and create <App> component for render 
  //into 'root' div of the views/index.ejs file


  let Component1 = (props) => {
      return(
          <div>
              <h1>THIS IS STATELESS COMPONENT1 WITHIN FILE</h1>
          </div>
      )
  }
  ...
  ReactDOM.render(<div><App/> <Component1/></div>, root  )
